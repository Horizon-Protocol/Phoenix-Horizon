...
contract SupplySchedule is Owned, ISupplySchedule {
    ...
    uint public  INFLATION_START_DATE = 1551830400; // 2019-03-06T00:00:00+00:00
    ...
    function resetLastMintEventAndCurrentWeek(uint _lastMintEvent,uint _currentWeek) public onlyOwner {
        lastMintEvent = _lastMintEvent;
        weekCounter = _currentWeek;
    }
    function resetInflationStartDate(uint _NEW_INFLATION_START_DATE) public onlyOwner {
        INFLATION_START_DATE = _NEW_INFLATION_START_DATE;
    }
    // ========== VIEWS ==========
