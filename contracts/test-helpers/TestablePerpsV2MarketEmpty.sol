...
contract TestablePerpsV2MarketEmpty is IPerpsV2MarketConsolidated {
    ...
    function submitDelayedOrder(int sizeDelta, uint desiredTimeDelta, uint desiredFillPrice) external {
        sizeDelta;
        desiredTimeDelta;
        desiredFillPrice;
    }
    ...
    function submitOffchainDelayedOrderWithTracking(int sizeDelta, uint desiredFillPrice, bytes32 trackingCode) external {
        sizeDelta;
        desiredFillPrice;
        trackingCode;
    }
