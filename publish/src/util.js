...
const getExplorerLinkPrefix = ({ network, useOvm }) => {
	return network === 'mainnet' ? `https://bscscan.com/` : `https://sepolia.arbiscan.io/`;
...
const loadConnections = ({ network, useFork, useOvm }) => {
	...
	const etherscanUrl = network === 'mainnet' ? `https://api.bscscan.com/api` : `https://api-sepolia.arbiscan.io/api`;
